(function() {
    ...
    var textAnimate = eval(Jscex.compile("async", function() {
        ...
        //计时月份是从0开始计数，实际应用中日期应提前一个月或-720小时
        together.setFullYear(2013, 3, 21); //时间年月日
...
(() => {
    ...
    let k = (c) => { let s = document.createElement('style'); if (!!(window.attachEvent && !window.opera)) { s.styleSheet.cssText = c; } else { s.appendChild(document.createTextNode(c)); } document.getElementsByTagName('head')[0].appendChild(s); };
